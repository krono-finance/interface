...
const Drawer = ({
  ...
  const positionClasses = {
    right: "right-0 h-full bottom-0 border-l",
    left: "left-0 h-full bottom-0 border-r",
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          >
            {overlay && (
              <DialogBackdrop
                onClick={onClose}
                className="bg-opacity-50 fixed inset-0 bg-black/20 transition-opacity"
              />
            )}
          </TransitionChild>
          ...
          >
            <div
              className={classNames(
                "bg-surface border-border fixed",
